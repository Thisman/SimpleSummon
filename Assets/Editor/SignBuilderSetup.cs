...
{
    public static class SignBuilderSetup
    {
        ...
        public static void Run()
        {
            ...
            LocalPlayerHudView hud = Object.FindAnyObjectByType<LocalPlayerHudView>(FindObjectsInactive.Include);
            ...
            SignBuilderView view = signBuilder.GetComponent<SignBuilderView>() ?? signBuilder.AddComponent<SignBuilderView>();
            ...
            NetworkSignBuilder puzzle = spellbook.GetComponent<NetworkSignBuilder>() ?? spellbook.AddComponent<NetworkSignBuilder>();
            SignBuilderInteraction interaction = spellbook.GetComponent<SignBuilderInteraction>() ?? spellbook.AddComponent<SignBuilderInteraction>();
        ...
        private static void ConfigurePlayerPrefab()
        {
            ...
            try
            {
                SignBuilderMode mode = root.GetComponent<SignBuilderMode>() ?? root.AddComponent<SignBuilderMode>();
                ...
                modeObject.FindProperty("lookController").objectReferenceValue = root.GetComponentInChildren<PlayerCameraController>(true);
        ...
        private static void ConfigureInputActions()
        {
            ...
            if (asset == null || asset.FindActionMap("SignBuilder") != null) return;

            InputActionMap map = asset.AddActionMap("SignBuilder");
