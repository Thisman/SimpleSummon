...
{
    public sealed class SignBuilderServiceTests
    {
        [Test]
        public void MoveThenAddFragments_AppliesBothOperationsInOrder()
        {
            ...
            SignBuilderService service = new(new FixedRandomSource());

            Assert.That(service.Move(board, 0, SignBuilderMoveDirection.Right), Is.True);
