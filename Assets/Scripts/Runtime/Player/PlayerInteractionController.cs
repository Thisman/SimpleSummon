...
namespace SimpleSummon.Runtime
{
    public sealed class PlayerInteractionController : MonoBehaviour
    {
        ...
        private void SetTarget(InteractiveActor actor)
        {
            ...
            ResolvePromptView()?.Show(GameLocalizationController.TranslateRaw(currentActor.InteractionText));
        }
        ...
        {
            if (promptView == null && LocalPlayerHudController.Instance != null)
            {
                promptView = LocalPlayerHudController.Instance.InteractionPrompt;
            }
