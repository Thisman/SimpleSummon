...
{
    internal sealed class SignCanvasCoordinates
    {
        private readonly RectTransform signContainer;

        public SignCanvasCoordinates(RectTransform signContainer)
        {
        ...
        public bool TryNormalize(Vector2 screenPoint, out Vector2 normalized)
        {
            ...
            Rect square = SignDrawingGraphic.GetSquareRect(signContainer.rect);
